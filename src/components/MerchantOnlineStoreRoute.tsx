...
const s:Record<string,React.CSSProperties>={
  page:{minHeight:"100vh",background:"#f5f8f6",padding:"28px 18px 70px",fontFamily:"Inter,system-ui,sans-serif",color:"#17231c"},center:{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",gap:10,fontFamily:"Inter,system-ui,sans-serif",color:"#536159"},back:{maxWidth:1120,margin:"0 auto 22px",display:"flex",alignItems:"center",gap:7,color:"#4f5f56",fontWeight:750,textDecoration:"none"},card:{maxWidth:1120,margin:"0 auto",display:"grid",gridTemplateColumns:"minmax(300px,42%) 1fr",alignItems:"center",gap:"clamp(24px,5vw,58px)",background:"white",border:"1px solid #dde6e1",borderRadius:28,padding:"clamp(22px,5vw,52px)",boxShadow:"0 22px 60px rgba(18,47,32,.07)"},visual:{display:"flex",justifyContent:"center",alignItems:"center"},image:{width:"100%",maxWidth:430,height:"auto"},content:{minWidth:0},kicker:{display:"inline-flex",alignItems:"center",gap:7,color:"#0f766e",fontSize:11,fontWeight:900,letterSpacing:".12em"},h1:{fontSize:"clamp(30px,4vw,48px)",lineHeight:1.04,letterSpacing:"-.045em",margin:"12px 0 14px"},lead:{color:"#66736c",fontSize:15,lineHeight:1.7,maxWidth:650},points:{display:"grid",gap:9,margin:"20px 0",color:"#3e5146",fontSize:13,fontWeight:700},actions:{display:"flex",gap:9,flexWrap:"wrap",marginTop:22},primary:{display:"inline-flex",alignItems:"center",gap:7,padding:"12px 16px",borderRadius:12,background:"#183d2b",color:"white",fontWeight:850,textDecoration:"none"},secondary:{display:"inline-flex",alignItems:"center",padding:"12px 16px",borderRadius:12,border:"1px solid #d9e2dd",color:"#34473c",fontWeight:800,textDecoration:"none",background:"white"}
};
