...
const styles:Record<string,any>={page:{minHeight:"100vh",background:"#f6f8fb",padding:"30px 18px 70px",fontFamily:"Inter,system-ui,sans-serif",color:"#0f172a"},container:{maxWidth:1180,margin:"0 auto"},center:{minHeight:"70vh",display:"flex",gap:10,alignItems:"center",justifyContent:"center",fontFamily:"Inter,system-ui,sans-serif"},back:{display:"inline-flex",alignItems:"center",gap:7,textDecoration:"none",color:"#475569",fontWeight:800,marginBottom:24},header:{display:"flex",justifyContent:"space-between",alignItems:"center",gap:20},eyebrow:{fontSize:11,fontWeight:900,letterSpacing:1.6,color:"#047857"},h1:{fontSize:"clamp(30px,4vw,46px)",margin:"7px 0",letterSpacing:-1.2},lead:{color:"#64748b",margin:0},tabs:{display:"flex",gap:8,overflowX:"auto",margin:"24px 0 15px"},tab:{border:"1px solid #dbe2ea",background:"#fff",borderRadius:12,padding:"10px 14px",fontWeight:800,whiteSpace:"nowrap",cursor:"pointer"},tabActive:{background:"#0f766e",color:"#fff",borderColor:"#0f766e"},grid2:{display:"grid",gridTemplateColumns:"minmax(280px,.8fr) minmax(360px,1.2fr)",gap:15},card:{background:"#fff",border:"1px solid #e2e8f0",borderRadius:20,padding:20,boxShadow:"0 10px 32px rgba(15,23,42,.035)"},input:{width:"100%",boxSizing:"border-box",border:"1px solid #cbd5e1",borderRadius:11,padding:"10px 11px",margin:"5px 0",background:"#fff"},row:{display:"flex",gap:7,alignItems:"center"},primary:{display:"inline-flex",alignItems:"center",justifyContent:"center",gap:7,border:0,borderRadius:12,padding:"11px 14px",background:"#10b981",color:"#052e2b",fontWeight:900,cursor:"pointer",marginTop:8},secondary:{display:"inline-flex",alignItems:"center",gap:7,border:"1px solid #cbd5e1",borderRadius:12,padding:"10px 13px",background:"#fff",fontWeight:800,cursor:"pointer"},secondarySmall:{border:"1px solid #cbd5e1",borderRadius:9,padding:"6px 8px",background:"#fff",fontSize:11,fontWeight:800,cursor:"pointer"},notice:{marginTop:16,display:"flex",alignItems:"center",gap:8,background:"#ecfdf5",border:"1px solid #a7f3d0",color:"#065f46",padding:"11px 13px",borderRadius:12,fontWeight:750},notice:{},list:{display:"flex",flexDirection:"column",gap:7,maxHeight:560,overflowY:"auto"},product:{border:"1px solid #e2e8f0",borderRadius:13,padding:"11px",background:"#fff",display:"grid",gridTemplateColumns:"1fr auto auto",alignItems:"center",gap:10,textAlign:"left",cursor:"pointer"},productActive:{borderColor:"#5eead4",background:"#f0fdfa"},line:{border:"1px solid #e2e8f0",borderRadius:12,padding:"10px",display:"flex",alignItems:"center",justifyContent:"space-between"},group:{border:"1px solid #e2e8f0",borderRadius:14,padding:12},groupHead:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,marginBottom:8},actions:{display:"flex",gap:5},option:{display:"flex",justifyContent:"space-between",padding:"7px 3px",borderTop:"1px solid #f1f5f9"},iconBtn:{border:0,background:"#f1f5f9",width:34,height:34,borderRadius:9,display:"grid",placeItems:"center",cursor:"pointer"},iconBtnPrimary:{border:0,background:"#0f766e",color:"#fff",width:38,height:38,borderRadius:10,display:"grid",placeItems:"center",cursor:"pointer"},checkbox:{display:"flex",alignItems:"center",gap:8,padding:"8px 0",fontWeight:700},label:{display:"flex",flexDirection:"column",gap:4,fontWeight:800,marginBottom:8},empty:{padding:18,textAlign:"center",color:"#94a3b8",border:"1px dashed #cbd5e1",borderRadius:12}}
