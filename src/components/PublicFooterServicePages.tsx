...
const pageStyle = `
.pc-service-page{min-height:100vh;background:var(--bg,#f8fafc);color:var(--text-main,#0f172a)}
.pc-service-topbar{position:sticky;top:0;z-index:20;background:color-mix(in srgb,var(--surface,#fff) 92%,transparent);backdrop-filter:blur(14px);border-bottom:1px solid var(--border,#e2e8f0)}
...
.pc-service-brand{font-weight:900;letter-spacing:-.03em}.pc-service-brand span{color:var(--green,#16a34a)}
...
.pc-service-copy{padding:18px 0}.pc-service-kicker{display:inline-flex;align-items:center;gap:7px;color:var(--green,#16a34a);font-size:.76rem;font-weight:850;letter-spacing:.08em;text-transform:uppercase}
.pc-service-copy h1{font-size:clamp(2.15rem,5vw,3.7rem);line-height:1.02;letter-spacing:-.045em;margin:14px 0 16px}.pc-service-copy p{max-width:680px;color:var(--muted,#64748b);font-size:1rem;line-height:1.65}
.pc-service-points{display:grid;gap:10px;margin-top:24px}.pc-service-point{display:flex;gap:10px;align-items:flex-start;color:var(--muted,#64748b);font-size:.9rem}.pc-service-point svg{color:var(--green,#16a34a);flex:0 0 auto;margin-top:2px}
.pc-service-card{background:var(--surface,#fff);border:1px solid var(--border,#e2e8f0);border-radius:20px;padding:24px;box-shadow:0 20px 60px rgba(15,23,42,.08)}
.pc-service-card h2{font-size:1.35rem;margin:0 0 6px}.pc-service-card>p{margin:0 0 20px;color:var(--muted,#64748b);font-size:.88rem;line-height:1.5}
.pc-service-form{display:grid;gap:13px}.pc-service-form label{display:grid;gap:6px;font-size:.8rem;font-weight:750}.pc-service-form input,.pc-service-form select,.pc-service-form textarea{width:100%;min-height:46px;border:1px solid var(--border,#d7e0e8);border-radius:11px;background:var(--surface-2,#f8fafc);color:var(--text-main,#0f172a);padding:10px 12px;font:inherit;outline:none}.pc-service-form textarea{min-height:104px;resize:vertical}.pc-service-form input:focus,.pc-service-form select:focus,.pc-service-form textarea:focus{border-color:var(--green,#16a34a);box-shadow:0 0 0 3px color-mix(in srgb,var(--green,#16a34a) 15%,transparent)}
.pc-service-grid2{display:grid;grid-template-columns:1fr 1fr;gap:10px}.pc-service-submit{min-height:48px;border:0;border-radius:12px;background:var(--green,#16a34a);color:#052e16;font-weight:900;display:flex;align-items:center;justify-content:center;gap:8px;cursor:pointer}.pc-service-submit:disabled{opacity:.65;cursor:wait}
.pc-service-note{font-size:.74rem;color:var(--muted,#64748b);line-height:1.45}.pc-service-status{display:flex;gap:9px;align-items:flex-start;padding:12px 13px;border-radius:11px;font-size:.82rem;line-height:1.45}.pc-service-status--ok{background:#ecfdf5;color:#166534;border:1px solid #bbf7d0}.pc-service-status--error{background:#fef2f2;color:#b91c1c;border:1px solid #fecaca}
.pc-service-list{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;margin-top:36px}.pc-service-info{background:var(--surface,#fff);border:1px solid var(--border,#e2e8f0);border-radius:15px;padding:18px}.pc-service-info svg{color:var(--green,#16a34a)}.pc-service-info h3{margin:10px 0 5px;font-size:1rem}.pc-service-info p{margin:0;color:var(--muted,#64748b);font-size:.82rem;line-height:1.5}
