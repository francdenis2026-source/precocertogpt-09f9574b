...
const s:Record<string,React.CSSProperties>={
  page:{minHeight:"100vh",background:"#f5f8f6",color:"#17231c",fontFamily:"Inter,system-ui,sans-serif",padding:"28px 18px 70px"},container:{maxWidth:1120,margin:"0 auto"},center:{minHeight:"75vh",display:"flex",flexDirection:"column",gap:12,alignItems:"center",justifyContent:"center",fontFamily:"Inter,system-ui,sans-serif",textAlign:"center"},back:{display:"inline-flex",alignItems:"center",gap:7,color:"#526159",fontWeight:750,textDecoration:"none",marginBottom:24},header:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:24,marginBottom:20},eyebrow:{display:"block",fontSize:10,fontWeight:900,letterSpacing:".13em",color:"#0f766e"},h1:{fontSize:"clamp(34px,4vw,50px)",lineHeight:1,letterSpacing:"-.05em",margin:"8px 0 12px"},lead:{maxWidth:690,color:"#66736c",lineHeight:1.65,margin:0},statusCard:{minWidth:275,display:"flex",alignItems:"center",gap:11,border:"1px solid #dce4df",borderRadius:17,background:"white",padding:"14px 16px",color:"#68746d"},statusLive:{background:"#effbf2",borderColor:"#bfe5c9",color:"#17633a"},section:{background:"white",border:"1px solid #dfe6e2",borderRadius:20,padding:"22px",marginTop:14,boxShadow:"0 10px 30px rgba(20,51,35,.035)"},sectionHead:{display:"flex",justifyContent:"space-between",gap:12,alignItems:"center",marginBottom:16},checkGrid:{display:"grid",gridTemplateColumns:"repeat(2,minmax(0,1fr))",gap:10},checkCard:{display:"flex",gap:12,border:"1px solid #e5e9e7",borderRadius:15,padding:15,background:"#fafbfa"},checkOk:{background:"#f2fbf4",borderColor:"#cbe6d1"},checkIcon:{width:38,height:38,borderRadius:12,display:"grid",placeItems:"center",background:"#eef1ef",color:"#66736c",flex:"0 0 auto"},checkIconOk:{background:"#dff4e4",color:"#17633a"},hint:{color:"#6b7770",fontSize:13,lineHeight:1.6},textarea:{width:"100%",boxSizing:"border-box",border:"1px solid #d9e1dc",borderRadius:13,padding:13,font:"inherit",resize:"vertical",marginTop:8},messageFoot:{display:"flex",alignItems:"center",justifyContent:"space-between",marginTop:8,color:"#78837d"},secondary:{display:"inline-flex",alignItems:"center",gap:7,border:"1px solid #d9e1dc",background:"white",color:"#34473c",borderRadius:11,padding:"9px 12px",fontWeight:750,cursor:"pointer"},publish:{marginTop:14,border:"1px solid #dedfdc",borderRadius:20,padding:22,display:"flex",alignItems:"center",justifyContent:"space-between",gap:20,background:"#f8f8f6"},publishReady:{background:"linear-gradient(135deg,#f0fbf3,#f7fbef)",borderColor:"#c7e4ce"},primary:{display:"inline-flex",alignItems:"center",gap:8,border:0,borderRadius:12,padding:"12px 16px",background:"#183d2b",color:"white",fontWeight:850,cursor:"pointer",whiteSpace:"nowrap"},pause:{display:"inline-flex",alignItems:"center",gap:8,border:"1px solid #e4cece",borderRadius:12,padding:"12px 16px",background:"#fff8f8",color:"#934545",fontWeight:850,cursor:"pointer",whiteSpace:"nowrap"},disabled:{opacity:.45,cursor:"not-allowed"},notice:{padding:"11px 13px",borderRadius:11,background:"#eef8f1",border:"1px solid #cde5d4",color:"#226540",fontWeight:700,marginBottom:12}
};
