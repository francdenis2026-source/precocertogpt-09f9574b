...
const s:Record<string,React.CSSProperties>={
 ...
 head:{position:"relative",minHeight:88,padding:"11px 190px 10px 20px",display:"flex",alignItems:"center",overflow:"hidden",background:"linear-gradient(135deg,#fbf8fc,#f1e9f3)",borderBottom:"1px solid #e8dfea"},kicker:{fontSize:9,fontWeight:900,letterSpacing:".14em",color:"#7a4e83"},bookName:{fontWeight:850,color:"#513d57",margin:"4px 0 1px",fontSize:12},headText:{color:"#756a78",fontSize:11,lineHeight:1.4},
