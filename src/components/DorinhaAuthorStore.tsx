...
export function DorinhaAuthorStore() {
  ...
  return <main style={s.page} className="db-author-page">
    <style>{`
      ...
      .db-real-cover-shell{position:relative;height:210px;display:grid;place-items:center;overflow:hidden;padding:14px;background:linear-gradient(145deg,#24102b 0%,#3a1d40 52%,#6c4a52 100%);isolation:isolate}
      ...
      .db-cover-placeholder{position:absolute;color:rgba(255,255,255,.72);font-size:11px}.db-real-cover-badge{position:absolute;right:9px;bottom:8px;padding:4px 6px;border:1px solid rgba(255,255,255,.22);border-radius:999px;background:rgba(31,15,37,.72);color:#f6dfae;font-size:8px;font-weight:800;letter-spacing:.08em}
      ...
      .db-video-copy{position:relative;padding-left:64px}.db-video-copy p{max-width:390px;margin:0;color:#665b69;font-size:14px;line-height:1.6}
      .db-video-mark{position:absolute;left:0;top:2px;width:46px;height:46px;color:#6a466f;filter:drop-shadow(0 7px 13px rgba(63,34,70,.12))}
      .db-video-frame{position:relative;width:100%;max-width:610px;justify-self:end;aspect-ratio:16/9;overflow:hidden;border:1px solid #cfbfce;border-radius:14px;background:linear-gradient(145deg,#211028,#3b1c42);box-shadow:0 16px 38px rgba(35,17,41,.14)}
      .db-video-frame iframe{position:absolute;inset:0;width:100%;height:100%;border:0}
      .db-video-link{display:inline-flex;align-items:center;gap:7px;margin-top:16px;padding:10px 13px;border:1px solid #d6cad7;border-radius:9px;background:#fff;color:#35243d;text-decoration:none;font-size:13px;font-weight:750}
      ...
      .db-platform-illustration{width:142px;height:82px;justify-self:end;color:#69486f;filter:drop-shadow(0 9px 18px rgba(54,30,61,.1))}
    ...
    <section style={s.videoWrap}>
      <div style={s.videoSection} className="db-section db-video-grid">
        <div className="db-video-copy">
          <svg className="db-video-mark" viewBox="0 0 64 64" aria-hidden="true"><defs><linearGradient id="db-play-gold" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#f2d394"/><stop offset="1" stopColor="#ba8847"/></linearGradient></defs><circle cx="32" cy="32" r="29" fill="#34203f"/><circle cx="32" cy="32" r="23" fill="none" stroke="url(#db-play-gold)" strokeWidth="1.5"/><path d="M27 22.5 44 32 27 41.5Z" fill="url(#db-play-gold)"/></svg>
    ...
    <section style={s.externalSection} className="db-section">
      <div className="db-external-head">
        ...
        <svg className="db-platform-illustration" viewBox="0 0 180 104" aria-hidden="true"><defs><linearGradient id="db-store-gold" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#f0d497"/><stop offset="1" stopColor="#b98345"/></linearGradient></defs><path d="M24 38h132l-10-18H34Z" fill="#35213f"/><path d="M30 38v48h120V38" fill="#fff" stroke="#6b4b70" strokeWidth="2"/><path d="M21 38h138v9c0 8-6 14-14 14s-14-6-14-14c0 8-6 14-14 14s-14-6-14-14c0 8-6 14-14 14s-14-6-14-14c0 8-6 14-14 14s-14-6-14-14c0 8-6 14-14 14S21 55 21 47Z" fill="url(#db-store-gold)"/><rect x="48" y="67" width="35" height="19" rx="3" fill="#eee6ef"/><rect x="103" y="62" width="25" height="24" rx="3" fill="#35213f"/><path d="M16 91h148" stroke="#6b4b70" strokeWidth="2" strokeLinecap="round"/></svg>
      </div>
...
const s: Record<string, React.CSSProperties> = {
  ...
  videoWrap:{backgroundColor:"#f3eef3",backgroundImage:"linear-gradient(90deg,rgba(247,244,239,.98) 0%,rgba(247,244,239,.94) 52%,rgba(247,244,239,.76) 100%),url('/dorinha-hero-editorial-v3.png')",backgroundPosition:"center,right 42%",backgroundSize:"cover,620px auto",backgroundRepeat:"no-repeat"},videoSection:{maxWidth:1060,margin:"0 auto",padding:"30px 24px"},videoTitle:{fontFamily:"Iowan Old Style,Palatino Linotype,Palatino,Georgia,serif",fontSize:"clamp(1.55rem,2.5vw,2.1rem)",lineHeight:1.12,letterSpacing:"-.025em",margin:"0 0 9px",fontWeight:700,color:"#271d2c"},
  externalSection:{maxWidth:1060,margin:"0 auto",padding:"32px 24px"},externalTitle:{fontFamily:"Iowan Old Style,Palatino Linotype,Palatino,Georgia,serif",fontSize:"clamp(1.55rem,2.5vw,2.1rem)",lineHeight:1.12,letterSpacing:"-.02em",margin:"0 0 7px",fontWeight:700},externalText:{maxWidth:620,color:"#5f5564",fontSize:14,lineHeight:1.6},externalCard:{background:"white",border:"1px solid #ddd3dc",borderRadius:11,padding:12,display:"grid",gridTemplateColumns:"34px 1fr auto",gap:9,alignItems:"center",color:"#302536",textDecoration:"none",transition:".2s ease"},sourceNote:{fontSize:11,color:"#6e6471",lineHeight:1.5,marginTop:11},
