            ...
            {profile.books.slice(0,4).map((book,index)=>{
              ...
              return src ? (
                <img 
                  ...
                  style={['uma-viagem-ao-mundo-da-imaginacao', 'mente-perversa', 'uma-historia-de-superacao'].includes(book.slug) ? { objectFit: 'cover' } : {}}
                />
              ) : null;
            })}
