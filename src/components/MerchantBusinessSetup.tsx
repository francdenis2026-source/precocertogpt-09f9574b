...
const styles: Record<string, any> = {
  page:{minHeight:"100vh",background:"#f6f8fb",color:"#111827",fontFamily:"Inter,system-ui,sans-serif",padding:"32px 18px 70px"},
  container:{maxWidth:1180,margin:"0 auto"},center:{minHeight:"70vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:12,fontFamily:"Inter,system-ui,sans-serif"},
  back:{display:"inline-flex",alignItems:"center",gap:7,color:"#475569",fontWeight:700,textDecoration:"none",marginBottom:26},
  header:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:28,marginBottom:28},eyebrow:{fontSize:11,fontWeight:900,letterSpacing:1.7,color:"#047857"},h1:{fontSize:"clamp(30px,4vw,48px)",lineHeight:1.05,letterSpacing:-1.5,margin:"8px 0 12px",maxWidth:720},lead:{color:"#64748b",fontSize:16,lineHeight:1.65,maxWidth:760,margin:0},
  storeBadge:{display:"flex",gap:11,alignItems:"center",background:"#fff",border:"1px solid #e2e8f0",borderRadius:18,padding:"13px 16px",minWidth:210,boxShadow:"0 8px 30px rgba(15,23,42,.05)"},
  section:{background:"#fff",border:"1px solid #e6eaf0",borderRadius:24,padding:"25px",marginTop:18,boxShadow:"0 12px 35px rgba(15,23,42,.035)"},sectionTitle:{display:"flex",gap:13,alignItems:"flex-start",marginBottom:20},step:{display:"grid",placeItems:"center",width:30,height:30,borderRadius:10,background:"#052e2b",color:"#fff",fontWeight:900},
  profileGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))",gap:12},profileCard:{position:"relative",textAlign:"left",border:"1px solid #e2e8f0",background:"#fff",borderRadius:18,padding:17,cursor:"pointer",display:"flex",flexDirection:"column",gap:8,minHeight:180},profileActive:{border:"2px solid #0f766e",background:"#f0fdfa",padding:16},profileIcon:{width:40,height:40,borderRadius:12,display:"grid",placeItems:"center",background:"#f1f5f9",color:"#334155"},profileIconActive:{background:"#0f766e",color:"#fff"},check:{position:"absolute",right:13,top:13,color:"#0f766e"},
  capabilityGrid:{display:"flex",flexWrap:"wrap",gap:8,marginBottom:18},capability:{display:"flex",alignItems:"center",gap:6,padding:"8px 11px",borderRadius:999,background:"#ecfdf5",color:"#065f46",fontWeight:750,fontSize:13},previewGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(230px,1fr))",gap:12},preview:{border:"1px solid #e2e8f0",borderRadius:17,padding:16,display:"flex",flexDirection:"column",gap:6},
  formGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:12},toggle:{border:"1px solid #e2e8f0",borderRadius:17,background:"#fff",padding:15,display:"flex",alignItems:"center",justifyContent:"space-between",gap:15,textAlign:"left",cursor:"pointer"},toggleActive:{borderColor:"#99f6e4",background:"#f0fdfa"},disabled:{opacity:.45,cursor:"not-allowed"},switch:{width:44,height:25,borderRadius:999,background:"#cbd5e1",padding:3,display:"block",transition:".2s"},switchActive:{background:"#0f766e"},knob:{width:19,height:19,borderRadius:999,background:"#fff",display:"block",transition:".2s"},knobActive:{transform:"translateX(19px)"},field:{border:"1px solid #e2e8f0",borderRadius:17,padding:15,display:"flex",alignItems:"center",justifyContent:"space-between",gap:15},input:{width:78,border:"1px solid #cbd5e1",borderRadius:10,padding:"8px 10px",fontWeight:800},
  pharmacy:{marginTop:18,display:"flex",gap:14,alignItems:"flex-start",background:"#fff7ed",border:"1px solid #fed7aa",borderRadius:20,padding:18,color:"#9a3412"},footer:{marginTop:22,background:"#0f172a",color:"#fff",borderRadius:22,padding:20,display:"flex",justifyContent:"space-between",alignItems:"center",gap:20},primary:{display:"inline-flex",alignItems:"center",justifyContent:"center",gap:8,border:0,borderRadius:13,padding:"12px 17px",background:"#10b981",color:"#052e2b",fontWeight:900,textDecoration:"none",cursor:"pointer",whiteSpace:"nowrap"},notice:{display:"flex",alignItems:"center",gap:8,background:"#ecfdf5",border:"1px solid #a7f3d0",color:"#065f46",borderRadius:14,padding:"12px 15px",fontWeight:750},
};
