...
const styles: Record<string, React.CSSProperties> = {
  ...
  sidebar:{background:"#10251b",color:"white",padding:"22px 16px",display:"flex",flexDirection:"column",gap:20,minHeight:"100vh",position:"sticky",top:0,height:"100vh"},brand:{display:"block",padding:"6px 8px"},storeIdentity:{display:"flex",alignItems:"center",gap:10,padding:"14px 10px",border:"1px solid rgba(255,255,255,.1)",borderRadius:14,background:"rgba(255,255,255,.04)"},storeAvatar:{width:38,height:38,borderRadius:12,display:"grid",placeItems:"center",background:"#e8ff66",color:"#10251b"},sidebarMuted:{display:"block",opacity:.62,marginTop:3},nav:{display:"grid",gap:5},navButton:{border:0,background:"transparent",color:"rgba(255,255,255,.75)",borderRadius:10,padding:"11px 12px",display:"flex",alignItems:"center",gap:10,textAlign:"left",cursor:"pointer",fontWeight:650},navActive:{background:"#e8ff66",color:"#10251b"},backLink:{marginTop:"auto",color:"rgba(255,255,255,.72)",textDecoration:"none",padding:10,fontSize:13},main:{padding:"28px clamp(18px,3vw,42px)",minWidth:0},header:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:20,marginBottom:22},h1:{fontSize:"clamp(27px,3vw,40px)",letterSpacing:"-.04em",margin:"5px 0"},h2:{fontSize:"clamp(21px,2vw,28px)",letterSpacing:"-.03em",margin:"4px 0 7px"},eyebrow:{display:"block",fontSize:10,fontWeight:850,letterSpacing:".12em",opacity:.55},muted:{color:"#68736c",fontSize:13},secondaryButton:{border:"1px solid #d8ddda",background:"white",borderRadius:11,padding:"10px 14px",display:"flex",alignItems:"center",gap:8,cursor:"pointer",fontWeight:700},primaryButton:{border:0,background:"#183d2b",color:"white",borderRadius:11,padding:"11px 15px",display:"inline-flex",alignItems:"center",justifyContent:"center",gap:7,cursor:"pointer",fontWeight:800,textDecoration:"none"},rejectButton:{border:"1px solid #efb5b5",background:"#fff5f5",color:"#9a3030",borderRadius:11,padding:"10px 13px",display:"inline-flex",alignItems:"center",gap:6,cursor:"pointer",fontWeight:800},notice:{padding:"12px 14px",background:"#eefbd9",border:"1px solid #cce99a",borderRadius:12,marginBottom:16,display:"flex",justifyContent:"space-between"},close:{border:0,background:"transparent",cursor:"pointer",fontSize:18},metrics:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(190px,1fr))",gap:12,marginBottom:16},metric:{background:"white",border:"1px solid #e2e6e3",borderRadius:16,padding:18,display:"flex",gap:13,boxShadow:"0 6px 24px rgba(17,41,29,.04)"},metricIcon:{width:38,height:38,borderRadius:12,display:"grid",placeItems:"center",background:"#eff4f0",color:"#183d2b"},metricValue:{display:"block",fontSize:22,margin:"4px 0 3px",letterSpacing:"-.03em"},section:{background:"white",border:"1px solid #e2e6e3",borderRadius:18,padding:"clamp(16px,2.2vw,26px)",boxShadow:"0 8px 30px rgba(17,41,29,.04)",marginBottom:16},reviewSection:{borderColor:"#f3c98b",background:"#fffaf1"},sectionHead:{display:"flex",justifyContent:"space-between",alignItems:"center",gap:14,marginBottom:18},live:{display:"flex",alignItems:"center",gap:7,fontSize:12,fontWeight:700,color:"#33714d"},kanban:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(190px,1fr))",gap:10},kanbanCol:{padding:10,background:"#f7f9f7",borderRadius:14,minHeight:180},kanbanTitle:{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"5px 4px 10px",fontSize:13,fontWeight:800},miniOrder:{width:"100%",border:"1px solid #e1e5e2",background:"white",borderRadius:10,padding:"10px",display:"flex",justifyContent:"space-between",alignItems:"center",textAlign:"left",marginBottom:7,cursor:"pointer"},empty:{padding:22,textAlign:"center",fontSize:12,color:"#8b948f"},orderGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(330px,1fr))",gap:14},orderCard:{border:"1px solid #dfe4e1",borderRadius:15,padding:17,background:"#fff"},reviewCard:{borderColor:"#e9bb75"},orderTop:{display:"flex",justifyContent:"space-between",gap:14},orderNumber:{fontSize:11,fontWeight:850,color:"#357451"},orderTitle:{fontSize:18,margin:"3px 0"},status:{display:"inline-block",fontSize:11,fontWeight:800,background:"#eefbd9",padding:"5px 8px",borderRadius:999},reviewStatus:{background:"#fff0d7",color:"#8a4f0e"},orderTotal:{display:"block",fontSize:18,marginTop:7},orderInfoGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(130px,1fr))",gap:8,margin:"15px 0",padding:"12px 0",borderTop:"1px solid #edf0ee",borderBottom:"1px solid #edf0ee",fontSize:12},itemList:{display:"grid",gap:7},itemRow:{display:"flex",justifyContent:"space-between",gap:8,fontSize:12},itemMeta:{color:"#52715f"},itemNote:{color:"#8a5b2d"},orderFooter:{display:"flex",justifyContent:"space-between",alignItems:"flex-end",gap:12,marginTop:15,flexWrap:"wrap"},reviewActions:{display:"flex",gap:7,flexWrap:"wrap"},totalBreakdown:{display:"grid",gap:3,fontSize:11,color:"#707b74"},emptyLarge:{padding:50,textAlign:"center",color:"#77827b",gridColumn:"1/-1"},infoHero:{display:"flex",alignItems:"center",gap:16,marginBottom:22,flexWrap:"wrap"},bigIcon:{width:58,height:58,borderRadius:18,display:"grid",placeItems:"center",background:"#e8ff66",color:"#173a29"},infoGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(210px,1fr))",gap:12},infoBox:{position:"relative",border:"1px solid #e2e6e3",borderRadius:14,padding:17,minHeight:120},paymentHero:{display:"flex",alignItems:"center",gap:16,justifyContent:"space-between",marginBottom:24,flexWrap:"wrap"},paymentIcon:{width:58,height:58,borderRadius:18,display:"grid",placeItems:"center",background:"#eaf3ff",color:"#2367a8"},center:{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:12,padding:30,textAlign:"center",fontFamily:"Inter,system-ui,sans-serif"}
};
