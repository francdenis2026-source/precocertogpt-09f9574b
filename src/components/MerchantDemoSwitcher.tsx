...
const s:Record<string,React.CSSProperties>={wrap:{position:"fixed",left:18,bottom:18,zIndex:1200,display:"flex",alignItems:"center",gap:8,padding:"9px 11px",border:"1px solid #d7e2dc",borderRadius:14,background:"rgba(255,255,255,.96)",boxShadow:"0 14px 36px rgba(15,50,32,.14)",backdropFilter:"blur(10px)",fontFamily:"Inter,system-ui,sans-serif"},badge:{display:"inline-flex",alignItems:"center",gap:5,padding:"5px 7px",borderRadius:8,background:"#fff4cf",color:"#7a5300",fontSize:9,fontWeight:900,letterSpacing:".08em"},select:{maxWidth:280,border:0,outline:0,background:"transparent",color:"#22332a",fontWeight:800,fontSize:12,cursor:"pointer"}};